...
import { getTransactions, getAssets, getAccounts, getOwners, getSoldPositions, getCurrencyRates, getActiveHoldings } from '../api';
...
describe('Transactions page — export integration', () => {
  beforeEach(() => {
    ...
    (getCurrencyRates as any).mockResolvedValue({ data: [] });
    (getActiveHoldings as any).mockResolvedValue({ data: [] });
  });
